...
interface IGeneration1Sprite {
    "red-blue": Pick<ISpriteVariant, "back_default" | "back_gray" | "front_default" | "front_gray" | "back_transparent" | "front_transparent">;
    yellow: Pick<ISpriteVariant, "back_default" | "back_gray" | "front_default" | "front_gray" | "back_transparent" | "front_transparent">;
}

interface IGeneration2Sprite {
    crystal: Pick<ISpriteVariant, "back_default" | "back_shiny" | "front_default" | "front_shiny" | "back_transparent" | "front_transparent">;
    gold: Pick<ISpriteVariant, "back_default" | "back_shiny" | "front_default" | "front_shiny" | "back_transparent" | "front_transparent">;
    silver: Pick<ISpriteVariant, "back_default" | "back_shiny" | "front_default" | "front_shiny" | "back_transparent" | "front_transparent">;
}

interface IGeneration3Sprite {
    emerald: Pick<ISpriteVariant, "front_default" | "front_shiny">;
    "firered-leafgreen": Pick<ISpriteVariant, "back_default" | "back_shiny" | "front_default" | "front_shiny" | "back_transparent" | "front_transparent">;
    "ruby-sapphire": Pick<ISpriteVariant, "back_default" | "back_shiny" | "front_default" | "front_shiny" | "back_transparent" | "front_transparent">;
}
...
interface IGeneration4Sprite {
    "diamond-pearl": Pick<
        ...
        "front_female" |
        "front_shiny" |
        "front_shiny_female" | "front_transparent"
    >;
    "heartgold-soulsilver": Pick<
        ...
        "front_female" |
        "front_shiny" |
        "front_shiny_female" | "back_transparent" | "front_transparent"
    >;
    platinum: Pick<
        ISpriteVariant,
        "back_default" |
